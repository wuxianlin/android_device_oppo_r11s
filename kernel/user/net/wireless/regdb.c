...
static const struct ieee80211_regdomain regdom_AR = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(57240, 63720, 2160, 0, 40, 0, 
...
static const struct ieee80211_regdomain regdom_AU = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5650, 5730, 80, 0, 24, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 0),
		REG_RULE_EXT(57240, 65880, 2160, 0, 43, 0, 
			NL80211_RRF_NO_OUTDOOR | 0),
	},
	.n_reg_rules = 7
};
...
static const struct ieee80211_regdomain regdom_CL = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5735, 5835, 80, 0, 20, 0, 0),
		REG_RULE_EXT(57240, 63720, 2160, 0, 50, 0, 
			NL80211_RRF_NO_OUTDOOR | 0),
	},
	.n_reg_rules = 4
};
...
static const struct ieee80211_regdomain regdom_CR = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(57240, 63720, 2160, 0, 30, 0, 0),
	},
	.n_reg_rules = 6
};
...
static const struct ieee80211_regdomain regdom_KR = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5730, 160, 0, 30, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 0),
		REG_RULE_EXT(57240, 65880, 2160, 0, 43, 0, 0),
	},
	.n_reg_rules = 6
};
...
static const struct ieee80211_regdomain regdom_PS = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2472, 40, 0, 30, 0, 0),
		REG_RULE_EXT(4940, 4990, 40, 0, 33, 0, 0),
	},
	.n_reg_rules = 2
};
...
static const struct ieee80211_regdomain regdom_UA = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5670, 160, 0, 20, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 20, 0, 0),
		REG_RULE_EXT(57240, 65880, 2160, 0, 20, 0, 0),
	},
	.n_reg_rules = 6
};
...
static const struct ieee80211_regdomain regdom_US = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5900, 5920, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5910, 5930, 10, 0, 30, 0, 0),
		REG_RULE_EXT(57240, 70200, 2160, 0, 40, 0, 0),
	},
	.n_reg_rules = 16
};
