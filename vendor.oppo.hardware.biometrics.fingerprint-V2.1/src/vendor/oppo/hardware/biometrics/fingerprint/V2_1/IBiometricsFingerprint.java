...
public interface IBiometricsFingerprint extends android.hidl.base.V1_0.IBase {
    ...
    public static IBiometricsFingerprint getService(String serviceName) throws android.os.RemoteException {
        return IBiometricsFingerprint.asInterface(android.os.HwBinder.getService("vendor.oppo.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprint",serviceName));
    }

    public static IBiometricsFingerprint getService() throws android.os.RemoteException {
        return IBiometricsFingerprint.asInterface(android.os.HwBinder.getService("vendor.oppo.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprint","default"));
    }
    ...
    int continueEnroll()
        throws android.os.RemoteException;
    int setTouchEventListener()
        throws android.os.RemoteException;
    int dynamicallyConfigLog(int on)
        throws android.os.RemoteException;
    int pauseIdentify()
        throws android.os.RemoteException;
    ...
    int getAlikeyStatus()
        throws android.os.RemoteException;
    int getEnrollmentTotalTimes()
        throws android.os.RemoteException;
    int setScreenState(int screen_state)
        throws android.os.RemoteException;
    int getEngineeringInfo(int type)
        throws android.os.RemoteException;
    ...
    public static final class Proxy implements IBiometricsFingerprint {
        ...
        public int cleanUp()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(11 /* cleanUp */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public int pauseEnroll()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(12 /* pauseEnroll */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public int continueEnroll()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(13 /* continueEnroll */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public int setTouchEventListener()
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFingerprint.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(14 /* setTouchEventListener */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public int dynamicallyConfigLog(int on)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFingerprint.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(15 /* dynamicallyConfigLog */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public int pauseIdentify()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(16 /* pauseIdentify */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public int continueIdentify()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(17 /* continueIdentify */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public int getAlikeyStatus()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(18 /* getAlikeyStatus */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public int getEnrollmentTotalTimes()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(19 /* getEnrollmentTotalTimes */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public int setScreenState(int screen_state)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFingerprint.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(20 /* setScreenState */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public int getEngineeringInfo(int type)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFingerprint.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(21 /* getEngineeringInfo */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IBiometricsFingerprint {
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-64,99,-119,-123,12,-21,-101,-44,61,-78,-69,3,82,-75,15,125,-38,-91,-44,74,69,-59,-90,86,-6,-80,44,-85,37,-128,-113,70} /* bd97992baa836ef969711ae45992f40c172e3fef7f667a9f10159d815580bd12 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 11 /* cleanUp */:
                {
                    ...
                    int _hidl_out_debugErrno = cleanUp();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 12 /* pauseEnroll */:
                {
                    ...
                    int _hidl_out_debugErrno = pauseEnroll();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 13 /* continueEnroll */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);

                    int _hidl_out_debugErrno = continueEnroll();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 14 /* setTouchEventListener */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);

                    int _hidl_out_debugErrno = setTouchEventListener();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 15 /* dynamicallyConfigLog */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);

                    int on = _hidl_request.readInt32();
                    int _hidl_out_debugErrno = dynamicallyConfigLog(on);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 16 /* pauseIdentify */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);

                    int _hidl_out_debugErrno = pauseIdentify();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 17 /* continueIdentify */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);

                    int _hidl_out_debugErrno = continueIdentify();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 18 /* getAlikeyStatus */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);

                    int _hidl_out_debugErrno = getAlikeyStatus();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 19 /* getEnrollmentTotalTimes */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                ...
                case 20 /* setScreenState */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);

                    int screen_state = _hidl_request.readInt32();
                    int _hidl_out_debugErrno = setScreenState(screen_state);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    break;
                ...
                case 21 /* getEngineeringInfo */:
                {
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);

                    int type = _hidl_request.readInt32();
                    int _hidl_out_result = getEngineeringInfo(type);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_result);
                    _hidl_reply.send();
                    break;
