...
public final class FingerprintFingerId {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId.class) {
            return false;
        }
        vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId other = (vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId)otherObject;
    ...
    public static final java.util.ArrayList<FingerprintFingerId> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId _hidl_vec_element = new vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId();
