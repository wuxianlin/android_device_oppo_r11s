...
public interface IBiometricsFingerprintClientCallback extends android.hidl.base.V1_0.IBase {
    ...
    public static IBiometricsFingerprintClientCallback getService(String serviceName) throws android.os.RemoteException {
        return IBiometricsFingerprintClientCallback.asInterface(android.os.HwBinder.getService("vendor.oppo.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback",serviceName));
    }

    public static IBiometricsFingerprintClientCallback getService() throws android.os.RemoteException {
        return IBiometricsFingerprintClientCallback.asInterface(android.os.HwBinder.getService("vendor.oppo.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback","default"));
    }
    ...
    void onEnumerate(long deviceId, int fingerId, int groupId, int remaining)
        throws android.os.RemoteException;
    void onTouchDown(long deviceId)
        throws android.os.RemoteException;
    void onTouchUp(long deviceId)
        throws android.os.RemoteException;
    void onMonitorEventTriggered(int type, String data)
        throws android.os.RemoteException;
    void onImageInfoAcquired(int type, int quality, int match_score)
        throws android.os.RemoteException;
    void onSyncTemplates(long deviceId, java.util.ArrayList<Integer> fingerIds, int groupId)
        throws android.os.RemoteException;
    void onEngineeringInfoUpdated(int lenth, java.util.ArrayList<Integer> keys, java.util.ArrayList<String> values)
        throws android.os.RemoteException;
    ...
    public static final class Proxy implements IBiometricsFingerprintClientCallback {
        ...
        public void onTouchDown(long deviceId)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(7 /* onTouchDown */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void onTouchUp(long deviceId)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(8 /* onTouchUp */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void onMonitorEventTriggered(int type, String data)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(9 /* onMonitorEventTriggered */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void onImageInfoAcquired(int type, int quality, int match_score)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(10 /* onImageInfoAcquired */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public void onSyncTemplates(long deviceId, java.util.ArrayList<Integer> fingerIds, int groupId)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFingerprintClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(11 /* onSyncTemplates */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public void onEngineeringInfoUpdated(int lenth, java.util.ArrayList<Integer> keys, java.util.ArrayList<String> values)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFingerprintClientCallback.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(12 /* onEngineeringInfoUpdated */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IBiometricsFingerprintClientCallback {
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-67,-105,-103,43,-86,-125,110,-7,105,113,26,-28,89,-110,-12,12,23,46,63,-17,127,102,122,-97,16,21,-99,-127,85,-128,-67,18} /* bd97992baa836ef969711ae45992f40c172e3fef7f667a9f10159d815580bd12 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 9 /* onMonitorEventTriggered */:
                {
                    ...
                    onMonitorEventTriggered(type, data);
                    break;
                }
                ...
                case 10 /* onImageInfoAcquired */:
                {
                    ...
                    int type = _hidl_request.readInt32();
                    int quality = _hidl_request.readInt32();
                    int match_score = _hidl_request.readInt32();
                    onImageInfoAcquired(type, quality, match_score);
                    break;
                }
                ...
                case 11 /* onSyncTemplates */:
                {
                    ...
                    long deviceId = _hidl_request.readInt64();
                    java.util.ArrayList<Integer> fingerIds = _hidl_request.readInt32Vector();
                    int groupId = _hidl_request.readInt32();
                    onSyncTemplates(deviceId, fingerIds, groupId);
                    break;
                }
                ...
                case 12 /* onEngineeringInfoUpdated */:
                {
                    ...
                    int lenth = _hidl_request.readInt32();
                    java.util.ArrayList<Integer> keys = _hidl_request.readInt32Vector();
                    java.util.ArrayList<String> values = _hidl_request.readStringVector();
                    onEngineeringInfoUpdated(lenth, keys, values);
                    break;
                }
