...
public final class FingerprintAcquired {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAcquired.class) {
            return false;
        }
        vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAcquired other = (vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAcquired)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAcquiredInfo.toString(this.acquiredInfo));
        builder.append("}");
    ...
    public static final java.util.ArrayList<FingerprintAcquired> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAcquired _hidl_vec_element = new vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAcquired();
