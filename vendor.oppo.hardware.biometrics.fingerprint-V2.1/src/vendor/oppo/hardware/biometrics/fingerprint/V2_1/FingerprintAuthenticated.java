...
public final class FingerprintAuthenticated {
    public final vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId finger = new vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated.class) {
            return false;
        }
        vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated other = (vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated)otherObject;
    ...
    public static final java.util.ArrayList<FingerprintAuthenticated> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated _hidl_vec_element = new vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated();
