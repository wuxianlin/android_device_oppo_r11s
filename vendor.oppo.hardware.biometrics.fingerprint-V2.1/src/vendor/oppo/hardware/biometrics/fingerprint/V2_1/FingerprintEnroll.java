...
public final class FingerprintEnroll {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintEnroll.class) {
            return false;
        }
        vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintEnroll other = (vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintEnroll)otherObject;
    ...
    public static final java.util.ArrayList<FingerprintEnroll> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintEnroll _hidl_vec_element = new vendor.oppo.hardware.biometrics.fingerprint.V2_1.FingerprintEnroll();
