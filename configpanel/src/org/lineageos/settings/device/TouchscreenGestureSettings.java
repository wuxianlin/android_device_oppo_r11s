...
public class TouchscreenGestureSettings extends PreferenceActivity {
    ...
    protected void onResume() {
	   ...
	   mFlashLightPreference.setChecked(isFlashlightEnable != 0);
        ...
        mHapticFeedback.setChecked(LineageSettings.System.getInt(getContentResolver(),
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if(preference.getKey().equals(BLACK_SCREEN_SETTINGS_KEY)) {
            ...
            LineageSettings.System.putInt(getContentResolver(),
                    LineageSettings.System.TOUCHSCREEN_GESTURE_HAPTIC_FEEDBACK, mHapticFeedback.isChecked() ? 1 : 0);
            return true;
